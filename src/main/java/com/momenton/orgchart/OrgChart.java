...
public class OrgChart {
    ...
    public static void main(String[] args) throws Exception {
        BufferedReader br;
        if (args.length == 0) {
            br = new BufferedReader(new InputStreamReader(ClassLoader.getSystemResourceAsStream("input.txt")));
        } else {
            br = new BufferedReader(new FileReader(Paths.get(args[0]).toFile()));
        }
        String line;
